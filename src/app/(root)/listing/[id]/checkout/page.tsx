...
import { useGetDetailListingQuery } from "@/services/listing.services";
import { useRouter, useSearchParams } from "next/navigation";
import { useMemo, useState } from "react";
import moment from "moment";
import { moneyFormat } from "@/lib/utils";
import { useTransactionMutation } from "@/services/transaction.services";
          ...
          <div>
            ...
            <div className="rounded-[30px] mt-2.5 p-[30px] bg-white border border-border shadow-indicator space-y-5">
              ...
              <div className="space-y-5">
                ...
                <CardBooking title="Tax (15%)" value={moneyFormat.format(booking.tax)} />
