...
import { useGetDetailTransactionQuery } from "@/services/transaction.services";
    ...
    <main>
      ...
      >
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center font-semibold leading-6 w-[250px]">
            <Image
          ...
          <div className="flex items-center font-semibold leading-6">
            <Image
              ...
              className="w-5 h-5 mr-1"
            />
            {booking?.listing?.max_person} gbps
          </div>
        </div>
